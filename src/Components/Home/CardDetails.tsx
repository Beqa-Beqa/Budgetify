  ...
  return (
    <div className="prompt">
      <div style={{maxWidth: 515}} className="prompt-box rounded w-100">
        <div className="w-100 p-3 position-relative d-flex align-items-center justify-content-center">
          <div className="d-flex align-items-center justify-content-between w-100 ms-sm-5 me-5 ms-2 ">
            ...
            <div className="d-flex align-items-center gap-1">
              <div className="icon p-1" role="button">
                <MdOutlineModeEdit />
              </div>
        ...
        <div className="mx-sm-5 mx-2 px-sm-4 px-3 py-4 mb-5">
          <AccountInfoField hasLine title="Title" text={props.accountData.title} />
